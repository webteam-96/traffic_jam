...
namespace TrafficJam.Api.Migrations
{
    ...
    [Migration("20260909092420_AddAstrologerProfileAndReviews")]
    partial class AddAstrologerProfileAndReviews
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TrafficJam.Api.Data.Entities.PanchangCache", b =>
                {
                    ...
                    b.Property<DateTime?>("AbhijitCleanEnd")
                        .HasColumnType("datetime(6)");

                    b.Property<DateTime?>("AbhijitCleanStart")
                        .HasColumnType("datetime(6)");
